...
document.querySelectorAll('.photo-masonry img').forEach((img, i) => {
    img.addEventListener('click', () => {
        ...
        lightboxVideoWrap.style.display = 'none';
        lightboxPhotoWrap.classList.add('is-active');
        lightboxTitle.innerHTML  = 'Focení';
